...
final pokemonInfoPageProvider = FutureProvider.autoDispose((ref) async {
  ...
  await ref.watch(pokemonSpeciesRefProvider.notifier).getSpecies(speciesUrl: speciesUrl);
  await ref.watch(pokemonEvolutionChainRefProvider.notifier).getEvolutionChain();
